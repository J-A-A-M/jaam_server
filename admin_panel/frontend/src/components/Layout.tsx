...
import { LayoutDashboard, MapPin, Cpu, Server, LogOut, Radar, ClipboardList, Users, Activity, Sun, Moon, Menu, X, UserCog, SlidersHorizontal } from "lucide-react";
...
const nav = [
  ...
  { to: "/settings", label: "Налаштування", icon: SlidersHorizontal, adminOnly: true },
];
